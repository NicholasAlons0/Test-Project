# Test-Project
# PP1 Concluded die is fair because a 3 was rolled. The probability that it would be judged unfair is 1/6 chance.If he dice were unfair, the chance that it would be judged fair is a 5/6 chance.
unfair <- 1/6
fair <- 5/6
